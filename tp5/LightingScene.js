...
class LightingScene extends CGFscene
{
    ...
    this.tableAppearance.setDiffuse(0.6,0.3,0,1);
    this.tableAppearance.setSpecular(0.1,0.1,0.1,1);
    this.tableAppearance.setShininess(50);
		this.tableAppearance.loadTexture("resources/images/table.png");

		this.floorAppearance = new CGFappearance(this);
		this.floorAppearance.setAmbient(0.9,0.7,0.5,1);
		this.floorAppearance.setDiffuse(0.9,0.7,0.5,1);
		this.floorAppearance.setSpecular(0.4,0.2,0.1,1);
